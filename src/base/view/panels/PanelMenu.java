...
public class PanelMenu extends JPanel implements KeyListener {
    ...
    public void title() {
        ...
        JLabel title = new JLabel("Игра приостановлена");
    ...
    public void velocityPlane() {
        ...
        JLabel velocityPlane = new JLabel("Скорость самолета");
    ...
    private void sliderFeatures(JSlider speedSlider) {
        ...
        speedSlider.setBackground(new Color(142, 173, 184));
    ...
    public void colorPlanes() {
        ...
        JLabel colorPlane = new JLabel("Цвет самолета");
    ...
    private void labelImagePlaneYellow() {
        configGBC(2, 4, 1, 1, GridBagConstraints.WEST, GridBagConstraints.CENTER);
    ...
    public void selectPlane() {
        ...
        JLabel imageSelectedPlane = new JLabel("<html><body>Выбранный<br>самолёт:</body></html>");
    ...
    public void optionButtons() {
        ...
        JButton buttonResume = new JButton("Возобновить");
        ...
        JButton buttonRestart = new JButton("Перезагрузить");
